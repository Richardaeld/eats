...
$(".polaroid-trans-1").mouseenter(function() {
    ...
    $(".polaroid-trans-2").css("transform", "translate(100px, -100px) rotate(-4deg)");
    $(".polaroid-trans-3").css("transform", "translate(-100px, 100px) rotate(7deg)");
    $(".polaroid-trans-4").css("transform", "translate(100px, 100px) rotate(-10deg)");
});
...
$(".polaroid-trans-2").mouseenter(function() {
    ...
    $(".polaroid-trans-1").css("transform", "translate(-100px, -100px) rotate(16deg)");
    $(".polaroid-trans-3").css("transform", "translate(0px, 100px) rotate(3deg)");
    $(".polaroid-trans-4").css("transform", "translate(100px, 100px) rotate(-10deg)");
...
$(".polaroid-trans-3").mouseenter(function() {
    ...
    $(".polaroid-trans-1").css("transform", "translate(-100px, -100px) rotate(16deg)");
    $(".polaroid-trans-2").css("transform", "translate(0px, -100px) rotate(-3deg)");
    $(".polaroid-trans-4").css("transform", "translate(100px, 100px) rotate(-10deg)");
